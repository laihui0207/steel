...
<div class="col-sm-12">
    ...
    <form:form commandName="news" method="post" action="newsform" cssClass="well"
        ...
        <form:select cssClass="form-control" path="newsType.id" items="${newsTypeList}" itemLabel="name"
                     itemValue="id"/>
        ...
        <form:input cssClass="form-control" path="thumbnailUrl" id="thumbnailUrl" maxlength="255" disabled="true"
                    placeholder="Thumbnail get From Content first Image"/>
