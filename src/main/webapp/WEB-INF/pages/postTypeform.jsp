...
<form:hidden path="id"/>
    ...
    <spring:bind path="postType.createTime">
    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
    </spring:bind>
        <appfuse:label key="postType.createTime" styleClass="control-label"/>
    ...
    <spring:bind path="postType.updateTime">
    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
    </spring:bind>
        <appfuse:label key="postType.updateTime" styleClass="control-label"/>
