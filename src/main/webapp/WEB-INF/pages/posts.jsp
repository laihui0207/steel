...
<display:table name="postList" class="table table-condensed table-striped table-hover" requestURI="" id="postList" export="true" pagesize="25">
    ...
    <display:column property="content" sortable="true" titleKey="post.content"/>
    ...
    <display:column property="thumbnailUrl" sortable="true" titleKey="post.thumbnailUrl"/>
    <display:column property="title" sortable="true" titleKey="post.title"/>
    <display:column property="updateTime" sortable="true" titleKey="post.updateTime"/>
