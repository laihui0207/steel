...
@Transactional
public class ReplyFormControllerTest extends BaseControllerTestCase {
    @Autowired
    private ReplyFormController controller;
    ...
    public void testSave() throws Exception {
        HttpSession session = mockMvc.perform(post("/replyform")
            )
