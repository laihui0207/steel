...
@Transactional
public class UserGroupFormControllerTest extends BaseControllerTestCase {
    @Autowired
    private UserGroupFormController controller;
    ...
    public void testEdit() throws Exception {
        ...
        mockMvc.perform(get("/userGroupform")
            .param("id", "-1"))
    ...
    public void testSave() throws Exception {
        HttpSession session = mockMvc.perform(post("/userGroupform")
            )
