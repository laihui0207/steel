...
<form:hidden path="id"/>
    ...
    <spring:bind path="newsType.createTime">
    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
    </spring:bind>
        <appfuse:label key="newsType.createTime" styleClass="control-label"/>
    ...
    <spring:bind path="newsType.updateTime">
    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
    </spring:bind>
        <appfuse:label key="newsType.updateTime" styleClass="control-label"/>
